  ...
  fields: [
    ...
    defineField({
      ...
      fields: [
        ...
        defineField({ name: 'cityEn', type: 'string', validation: (Rule) => Rule.required() }),
    ...
    defineField({
      ...
      type: 'object',
      fields: [
        defineField({ name: 'register', type: 'url', validation: (Rule) => Rule.required() }),
        defineField({ name: 'community', type: 'url', validation: (Rule) => Rule.required() }),
        defineField({ name: 'connpass', type: 'url', validation: (Rule) => Rule.required() }),
        defineField({ name: 'cocJa', type: 'url', validation: (Rule) => Rule.required() }),
        defineField({ name: 'cocEn', type: 'url', validation: (Rule) => Rule.required() }),
      ],
      validation: (Rule) => Rule.required(),
    }),
    defineField({
      ...
      of: [
        defineArrayMember({
          ...
          fields: [
            ...
            defineField({ name: 'label', type: 'string', validation: (Rule) => Rule.required() }),
            defineField({ name: 'sub', type: 'string', validation: (Rule) => Rule.required() }),
            defineField({ name: 'color', type: 'string', validation: (Rule) => Rule.required() }),
            defineField({ name: 'textColor', type: 'string', validation: (Rule) => Rule.required() }),
            ...
            defineField({
              ...
              of: [
                defineArrayMember({
                  ...
                  fields: [
                    defineField({ name: 'label', type: 'string', validation: (Rule) => Rule.required() }),
                    defineField({ name: 'note', type: 'string', validation: (Rule) => Rule.required() }),
                    defineField({ name: 'rail', type: 'string', validation: (Rule) => Rule.required() }),
                  ],
                }),
              ],
            }),
